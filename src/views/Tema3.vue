  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5.mb-5
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span 3
      h1 Normatividad de los procesos paneleros


    p Como cualquier proceso tecnificado y que impacta la dinámica social, económica, de salud, entre otras, de la población, los procesos paneleros se ven tocados por normativa y reglamentaciones que regulan los procedimientos, acciones y eventualidades propias.
    ...
    .row.mt-5.mb-5
      .col-12
        figure
          .video
            iframe(width="560" height="315" src="https://www.youtube.com/embed/d0lLJfCYUC0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen)
    ...
    .row.justify-content-center.mb-5
      .col-lg-8.col-12
        ImagenInfografica.color-acento-botones.mb-5
          ...
          .tarjeta.tarjeta-verde.p-3(x="3%" y="40%" numero="1")
